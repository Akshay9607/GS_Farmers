...
class _Crop_RecommendState extends State<Crop_Recommend> {
  ...
  Map cropRecommend = {
    0: ["assets/soil/cotton.jpg", "Cotton"],
    1: ["assets/soil/strawberry.jpg", "Strawberry"],
    2: ["assets/soil/tea.jpg", "Tea"],
    3: ["assets/soil/carrot.jpg", "Carrot"],
    4: ["assets/soil/maize.jpg", "Maize"],
  };
                  ...
                  _image.path == ""
                      ? Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              color: Colors.white),
                          child: IconButton(
                            icon: Image.asset("assets/soil/black.jpg"),
                            onPressed: pickImage,
                          ))
                      : Container(
                          padding: EdgeInsets.all(20.0),
